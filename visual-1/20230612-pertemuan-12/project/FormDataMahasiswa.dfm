object DataMahasiswa: TDataMahasiswa
  ...
  object ADODataSetMahasiswa: TADODataSet
    ...
    Left = 48
    Top = 16
    object ADODataSetMahasiswaID: TAutoIncField
      FieldName = 'ID'
      ReadOnly = True
    end
    object ADODataSetMahasiswanpm: TWideStringField
      FieldName = 'npm'
      Size = 15
    end
    object ADODataSetMahasiswanama_lengkap: TWideStringField
      FieldName = 'nama_lengkap'
      Size = 50
    end
    object ADODataSetMahasiswaprodi: TWideStringField
      FieldName = 'prodi'
      Size = 50
    end
    object ADODataSetMahasiswatanggal_lahir: TDateTimeField
      FieldName = 'tanggal_lahir'
      DisplayFormat = 'dd/mm/yyyy'
    end
    object ADODataSetMahasiswatempat_lahir: TWideStringField
      FieldName = 'tempat_lahir'
      Size = 50
    end
    object ADODataSetMahasiswajenis_kelamin: TWideStringField
      FieldName = 'jenis_kelamin'
      Size = 10
    end
  end
